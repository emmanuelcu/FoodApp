...
class MealTableViewController: UITableViewController {
    ...
    func loadSampleMeals(){
        ...
        let meal2 = Meal(name: "Potatos", photo: photo2, rating: 5)!
        
        let photo3 = UIImage(named: "meal3")!
        let meal3 = Meal(name: "Italian", photo: photo3, rating: 3)!
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("MealTableViewCellSegue", forIndexPath: indexPath) as! MealTableViewCell
    ...
    override func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        if editingStyle == .Delete {
            ...
            //With this line of code the code saves the meals array whenever a meal is deleted.
            saveMeals()
    ...
    */
    ...
    //All the code within the prepareForSegue(_:sender:) method is making an error.
